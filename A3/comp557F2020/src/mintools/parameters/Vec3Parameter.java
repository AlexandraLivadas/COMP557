...
public class Vec3Parameter extends JPanel {
	...
	public Vec3Parameter( String name, double xDefault, double yDefault, double zDefault ) {
	 this( name, xDefault, yDefault, zDefault, -10, 10 );
	}
	
	public Vec3Parameter( String name, double xDefault, double yDefault, double zDefault, double min, double max ) {
		xp = new DoubleParameter( "x", xDefault, min, max );
		yp = new DoubleParameter( "y", yDefault, min, max );
		zp = new DoubleParameter( "z", zDefault, min, max );
