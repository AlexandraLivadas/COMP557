...
public class FreeJoint extends GraphNode {
	...
	public FreeJoint( String name ) {
		...
		dofs.add( ty = new DoubleParameter( name+" ty", 1.5, -2, 2 ) );
	...
	public void display( GLAutoDrawable drawable, BasicPipeline pipeline ) {
		...
		// Objective 3: Freejoint, transformations must be applied before drawing children
		...
		pipeline.setModelingMatrixUniform(gl); // Need to set the matrices before drawing
